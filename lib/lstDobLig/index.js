...
export async function insertar_al_inicio_LD(){
    ...
    try{
        ...
        if(lista.buscar2(DATO)==true) throw new Error("EL NODO YA SE INGRESO");
...
export async function insertar_al_final_LD(){
    var canvas=document.getElementById('tutorial3');
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;	
...
export async function insertar_antes_X_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;	
...
export async function insertar_despues_X_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;	
...
export async function eliminar_al_inicio_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;		
...
export async function eliminar_al_final_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;		
...
export async function eliminar_X_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);	
        lista.canvas=canvas;	
    ...
    try{
        ...
        if(DATO==null || DATO=='') return;
        if(lista.buscar2(DATO)==false) throw new Error("EL NODO NO EXISTE");
...
export async function eliminar_antes_X_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;		
...
export async function eliminar_despues_X_LD(){
    var canvas=document.getElementById('tutorial3'); 
    if(lista==null){
        lista=new ListaDoblementeLigada(canvas);
        lista.canvas=canvas;		
